<%@ Page Title="" Language="C#" MasterPageFile="~/QLBH.Master" AutoEventWireup="true" CodeBehind="viewProductByType.aspx.cs" Inherits="QLBH.viewProductByType" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="bodyContent" runat="server">
    <asp:ListView ID="lvwProducts" runat="server" OnPagePropertiesChanging="lvwProducts_PagePropertiesChanging" OnItemDataBound="lvwProducts_ItemDataBound1" OnItemCommand="lvwProducts_ItemCommand">
        ...
        <ItemTemplate>
            <li>
                <a href="details?proId=<%# Eval("ProID") %>"><img src="Imgs/sp/<%# Eval("ProID") %>/main_thumbs.jpg" width="200" height="150" alt="<%# Eval("ProName") %>" title="<%# Eval("ProName") %>" /></a>
                <br />
                ...
                <a href="details?proId=<%# Eval("ProID") %>" class="btn btn-info">Chi tiết</a>
